...
public struct SpringConfig {
  ...
  public static func fromOrigamiTensionAndFriction(tension tension: Double, friction: Double) -> SpringConfig {
    return SpringConfig(
  ...
  public static func fromBouncinessAndSpeed(bounciness: Double, speed: Double) -> SpringConfig {
  ...
  public static func coastingConfigWithOrigamiFriction(friction: Double) -> SpringConfig {
    return SpringConfig(
      tension: 0,
      friction: OrigamiValueConverter.frictionFromOrigamiValue(friction)
    )
